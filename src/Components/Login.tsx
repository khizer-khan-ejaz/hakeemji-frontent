...
const Login = () => {
  ...
  return (
	<div className='w-[100vw] h-[100vh] flex justify-center items-center p-2'>
		...
		<div className='md:w-[40%] h-max flex flex-col justify-center items-center gap-[10px] p-4 border-[1px] shadow-lg rounded-md'>
		...
		<div className='flex flex-col justify-center items-start gap-[20px] p-2 w-[80%]'>
			...
			<div className='w-full flex'>
				<span className='no-select text-blue-500 underline ml-auto'>forget password ? </span>
			</div>
			</div>
		</div>
