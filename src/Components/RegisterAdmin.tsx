...
const RegisterAdmin = () => {
  ...
  return (
	<div className='flex w-[100vw] h-[100vh] justify-center items-center p-2'>

		<div className='md:w-[40%] h-max flex flex-col justify-center items-center gap-[10px] p-4 shadow-lg rounded-lg'>
