      ...
      <div className="col-lg-6 ">
       <div className="appoinment-content">
        ...
        <div className="emergency"style={{ background: "#65aaa1" }}>
         <h2 className="text-md"><i className="icofont icofont-phone-circle text-lg" ></i>+91 9990062706</h2>
        </div>
       </div>
      </div>
      <div className="col-lg-6 col-md-10 ">
       <div className="appoinment-wrap mt-5 mt-lg-0">
        ...
        <form id="#" className="appoinment-form" method="post" action="#">
         ...
         <a className="btn btn-main btn-round-full" href="appoinment.html"  style={{ background: "#65aaa1", border: "#db4733" }}>Make Appoinment <i className="icofont icofont-simple-right ml-2  "></i></a>
        </form>
       </div>
      </div>
     </div>
